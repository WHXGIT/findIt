...
<form class="main-lost" method="post" action="/credential/lost">
	...
	<div class="input-group main-lost-group">
		...
		<input type="text" name="lostTimeA" class="form-control main-lost-input" placeholder="丢失大概时间" aria-describedby="basic-addon1">
	</div>
	<div class="input-group main-lost-group">
		<span class="input-group-addon main-lost-name" id="basic-addon1">丢失大概地点：</span>
		<input name="lostAddress" type="text" class="form-control main-lost-input" placeholder="丢失大概地点" aria-describedby="basic-addon1">
	</div>
	<div class="input-group main-lost-group">
